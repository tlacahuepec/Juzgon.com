...
fun ItemFormRoute(
    ...
    ItemFormScreen(
        ...
        onConflictValueSelected = viewModel::onConflictValueSelected,
...
fun ItemFormScreen(
    ...
    onConflictValueSelected: (com.juzgon.domain.enrichment.EnrichmentCandidateValue) -> Unit = {},
    ...
    if (state.enrichmentSheet != EnrichmentSheetState.Hidden) {
        EnrichmentSuggestionSheet(
            ...
            onConflictResolved = onConflictValueSelected,
